...
const Navbar = ({theme, setTheme}) => {
  ...
  return (
    ...
    dark:bg-gray-900/70'>
      ...
      <div className={`text-gray-700 dark:text-wwhite sm:text-sm ${!sidebarOpen ? 'max-sm:w-0 overflow-hidden' :'max-sm:w-60 max-sm:pl-10'} max-sm:fixed
      ...
      <div className='flex items-center gap-2 sm:gap-4'>
        ...
        cursor-pointer hover:scale-103 transition-all'>
          Connect <img ssrc={assets.arrow_icon} width={14} alt='' />
        </a>
      </div>
