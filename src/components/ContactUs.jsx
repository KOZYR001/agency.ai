...
const ContactUs = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "bb476d35-4823-489f-b196-f3a2d0794c33");
  ...
  return (
    ...
    lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
        <Title title='Reach out to us' desc='From strategy to execution, we craftt digital solutions that move your business forward.'/>
        ...
        <form onSubmit={onSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
            ...
            <div className='sm:col-span-2'>
                ...
                <textarea name="message" rows={8} placeholder='Enter your message' className='w-full p-3 text-sm outline-none rounded-lg border
